// from https://github.com/mantinedev/mantine/blob/master/src/mantine-demos/src/demos/core/AppShell/AppShell.demo.navbar.tsx
import {
  ThemeIcon,
  ColorScheme,
  UnstyledButton,
...
const MantinePage = (props) => {
  ...
  return (
    <AppShell
      padding="md"
      navbar={
        <Navbar tw="min-h-screen flex flex-col" width={{ base: 300 }} p="xs">
          <Navbar.Section mt="xs">
            <MainLinks />
          </Navbar.Section>
          <Navbar.Section tw="flex-none">
            <User />
          </Navbar.Section>
        </Navbar>
      }
    ...
    >
      <div
        tw="space-y-8 font-family['Rubik'] p-5"
        css={cssIf(colorScheme === "dark", tw`text-gray-50`, tw`text-gray-900`)}
      >
        <h1 tw="text-2xl tracking-tight">
          Mantine works with strict inline styles
        </h1>
        <h2 tw="text-xl">
