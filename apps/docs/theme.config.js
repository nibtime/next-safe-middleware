...
// theme.config.js
export default {
  github: "https://github.com/nibtime/next-safe-middleware", // GitHub link in the navbar
  floatTOC: true,
  docsRepositoryBase:
    "https://github.com/nibtime/next-safe-middleware/blob/main/apps/docs/pages", // base URL for the docs repository
