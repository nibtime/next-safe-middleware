...
<Callout emoji="ℹ️">
  Since version [`0.9.0`](https://github.com/nibtime/next-safe-middleware/releases/tag/%40next-safe%2Fmiddleware%400.9.0), support for Beta middleware has been dropped, so your project needs to use Next.js `>= 12.2` with Stable root-level middleware. 
  
  For migration to Stable middleware, have a look at the [middleware upgrade guide](https://nextjs.org/docs/messages/middleware-upgrade-guide)
</Callout>
...
<Callout emoji="ℹ️">
  If you need additional guidance or details, have a look at the ["CSP
  violation reporting" guide](/guides/csp-violation-reporting).
</Callout>
